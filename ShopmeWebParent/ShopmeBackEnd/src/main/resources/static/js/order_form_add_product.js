...
function getProductInfo(productId, shippingCost) {
	...
	$.get(requestURL, function(productJson) {
		...
		productCost = $.number(productJson.cost, decimalDigits, decimalSeparator, thousandsSeparator);
		productPrice =  $.number(productJson.price, decimalDigits, decimalSeparator, thousandsSeparator);
